...
public class Projectile : MonoBehaviour
{
    ...
    public void SetUp(ClassBase InOwningClassScript, float InDamageAmount, float InAttackStrength, float InMaxDistance, bool LeftRight = false, float InHorizontalMovementAmount = 0, bool UpDown = true, float InVerticalMovementAmount = 0)
    {
        if (LeftRight)
        {
